      ...
      <ul class="clases-lista">
        ...
        >
          <span class="clase-icon">
            <template v-if="clase.tipo_archivo === 'video'">🎬</template>
            <template v-else-if="clase.tipo_archivo === 'pdf'">📄</template>
...
<script setup>
// Recibe los módulos y clases del curso y los pinta en forma de temario
